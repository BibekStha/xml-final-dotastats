...
<div id="profile_container" class="d-flex flex-column justify-content-center">
  ...
  <div class="container text-center profile_name_container d-flex flex-column">
    <span class="profile_name">{{ $player['profile']['personaname'] }}</span>
    <span class="profile_team_name">{{ $proplayer->team_name }}</span>
  </div>
  ...
  <div class="container">
      <h2 class="text-center player_hero_subheading">Heroes played with</h2>
